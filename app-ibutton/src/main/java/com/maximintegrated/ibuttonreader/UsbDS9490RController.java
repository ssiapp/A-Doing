...
public class UsbDS9490RController {
     ...
     */
    public UsbDS9490RController(Activity parentActivity, IUsbConnectionHandler connectionHandler, int vid, int pid) {
    ...
    private class DeviceCommands { // Runs in its own thread
        ...
        public void openUsbEP() {
            ...
            // 81 c3 80 3d 00 00 00 72

            // https://www.maximintegrated.com/cn/design/technical-documents/app-notes/5/5705.html
